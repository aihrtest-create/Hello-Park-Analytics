...
# =========================================
# Март 2026 (МСК → UTC: -3ч)
# =========================================
flux_query = '''
from(bucket: "Analytics_AvatarBD")
  |> range(start: 2026-02-28T21:00:00Z, stop: 2026-03-31T21:00:00Z)
...
print("🔄 Запрашиваю данные по привязанным аватарам за МАРТ 2026...")
...
try:
    ...
    if response.status_code == 200:
        ...
        print(f"   Получено фреймов (парков): {len(frames)}")
        ...
        if results:
            ...
            # Фильтруем только март 2026
            pivot_df = pivot_df[pivot_df.index.str.startswith("2026-03")]
            ...
            # Сохраняем в Excel
            output_file = "/Users/dima/Desktop/Hello Park Data/avatars_march_2026.xlsx"
            
            from openpyxl.styles import PatternFill, Font, Alignment
            from openpyxl.utils import get_column_letter
            
            with pd.ExcelWriter(output_file, engine="openpyxl") as writer:
                pivot_df.to_excel(writer, sheet_name="Март")
                ws = writer.sheets["Март"]
        ...
        print(f"❌ Ошибка Grafana: {response.status_code}")
